...
var mudsn,muid,mupwd,catalog,memudsn,memuid,memupwd,mecatalog,vs,ancientnum ,
guildsave:string;
//configs de tabela
...
//lang
loadingtext,errortext:string;   //into
...
BattleMasters,remassistent,rembattlemaster,SetBattleMaster,SetAssistent:string; //main
...
Confirm5,Confirm6,Error18,Error19,Error20,Error21,
Error22,error23,error24,question8,question9,question10:string; //mainmsg
