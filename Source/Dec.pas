...
var mudsn,muid,mupwd,catalog,memudsn,memuid,memupwd,mecatalog,vs,ancientnum5,ancientnum10 ,
guildsave:string;
//configs de tabela
G_name,G_mark,G_Score,G_Master,G_Count,G_notice,Guild,G_level2,G_status,  //guild
GameID1,GameID2,GameID3,GameID4,GameID5,AccountCharacter, ID, //Account Character
Nome2,G_Level,GuildMember,g_name2:string; //guildmember
   maxguilds:integer;
AccountSave,CharacterSave,tabela:string;
//configs de tabela
memb_info,memb___id,vip,creditos,moedas,  //memb_info

Character,inventory,shopitem,nome,magiclists:string; //character
gameserverinfo,itemcount:string;
warehouses,Money,AccountID,Items:string; //warehouse
//lang
...
ormode1,ormode2,ormode3,ormode4,ormode5,ormode6:string;  //excelent
...
Config,editcmtedit,ancientnormal,ancient5,ancient10,options,ancient52,ancient102:string; //main

ErrorCaption,Error1Part1,Error1Part2,Error1Part3,Error1Part4,
Error2,Error3Part1,Error3Part2,Error4Part1,Error4Part2,
Question1,Error5,Confirm1,Error6,Question2,
Question3,Error7,Error8,Error9,Error10,Error11Part1,
Error11Part2,Question3Caption,Question4,Question5,
Confirm2,Error12,Error13,Error14,error15part1,error15part2,
error15part3,error16,error17,question6,question7,Confirm3,
Confirm5,Confirm6,Error18,Error19,Error20,Error21,error25,error26,error27,error28 ,error29,
Error22,error23,error24,question8,question9,question10,question11,question12:string; //mainmsg
